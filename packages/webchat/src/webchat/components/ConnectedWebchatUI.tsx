...
export const ConnectedWebchatUI = connect<Pick<WebchatUIProps, 'messages' | 'open'>, Pick<WebchatUIProps, 'onSendMessage'>, Pick<WebchatUIProps, 'config' | 'plugins'>, StoreState>(
